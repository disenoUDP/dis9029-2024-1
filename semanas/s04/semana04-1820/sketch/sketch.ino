...
void loop()
{
  ...
  {                              // suma valor e itinera, siendo programado para que todos los led pins se enciendan al mismo tiempo, tras presionar botón
  ...
  {                              // sumar valor e itinera, siendo programado para que todos los ledpins se apaguen, tras presionar el valor
    digitalWrite(ledPin1, LOW);  // ledPin1 apagado
    digitalWrite(ledPin2, LOW);  // ledPin2 apagado
    digitalWrite(ledpin3, LOW);  // ledpin3 apagado
    digitalWrite(ledPin4, LOW);  // ledPin4 apagado
